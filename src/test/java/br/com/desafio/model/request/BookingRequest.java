...
public class BookingRequest {
    ...
    public BookingRequest(String firstname, String lastname, Integer totalprice, Boolean depositpaid, BookingDatesResponse bookingdates, String additionalneeds) {
    ...
    public BookingDatesResponse getBookingdates() { return bookingdates; }
    public void setBookingdates(BookingDatesResponse bookingdates) { this.bookingdates = bookingdates; }
